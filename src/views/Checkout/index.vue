...
<template>
      ...
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            ...
            <div class="action">
              <el-button size="large" @click="openDialog">切换地址</el-button>
              <el-button size="large" @click="openCityList">添加地址</el-button>
            </div>
          </div>
        </div>
        <!-- 商品信息 -->
  ...
  <!-- 添加地址 -->
  <el-dialog v-model="showCityList" title="添加地址" width="750px" center>
    <city-list />
    <template #footer>
      <span class="dialog-footer">
        <el-button @click="showCityList = false">取消</el-button>
